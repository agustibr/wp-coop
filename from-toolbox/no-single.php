...
get_header(); ?>
        ...
        <p>Written by: <?php the_author_link(); ?></p>
          ...
          Who has written  <a href="<?php bloginfo('url'); ?>/author/<?php the_author_nickname(); ?>"><?php the_author_posts(); ?></a> awesome articles for us
The <?php the_author_posts(); ?> will get the post count .
        </div>
