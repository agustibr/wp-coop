...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<?php if ( is_search() || is_author()) : // Only display Excerpts for Search ?>
	...
	<footer class="entry-meta">
		<?php if ( 'recepta' == get_post_type() ) : // Hide category and tag text for pages on Search ?>
			<?php
		...
		<?php if ( 'recepta' == get_post_type() ) : // Hide category and tag text for pages on Search ?>
			...
			<?php
				/* translators: used between list items, there is a space after the comma */
				$tags_list = get_the_term_list( get_the_ID(), 'rebost', 'Ingredients: ', ', ', '' );
				if ( $tags_list ) :
			?>
			<span class="tag-links">
